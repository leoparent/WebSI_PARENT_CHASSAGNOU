...
export default function Account({ session }) {
  ...
  return (
    <div className ="bg-gray-300 rounded-3xl py-10 flex justify-center items-center flex-col mx-auto w-1/2">
      ...
      <div>
    <button type="button" onClick={async (e) => { setAccentuation(e.target.value) }} value="bg-theme-bleu" className="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">blue</button>
    <button type="button" onClick= {(e) => setAccentuation(e.target.value)} value="bg-theme-violet" className="inline-block px-6 py-2.5 bg-purple-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-purple-700 hover:shadow-lg focus:bg-purple-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out">purple</button>
    <button type="button" onClick= {(e) => setAccentuation(e.target.value)} value="bg-theme-blanc" className="inline-block px-6 py-2.5 bg-white-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-white-700 hover:shadow-lg focus:bg-white-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-white-800 active:shadow-lg transition duration-150 ease-in-out">white</button>

    <button type="button" onClick= {(e) => setAccentuation(e.target.value)} value="bg-theme-vert" className="inline-block px-6 py-2.5 bg-green-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-600 hover:shadow-lg focus:bg-green-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-700 active:shadow-lg transition duration-150 ease-in-out">green</button>
