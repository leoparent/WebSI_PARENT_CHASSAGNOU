        ...
        <footer className={"dark:bg-black dark:border-gray-800 p-4 md:px-10 md:py-5 border-t-2  border-gray-200 mt-10 "+Accentuation}>
            ...
            <div className="md:flex md:items-center md:justify-between flex-row items-center text-center">
                ...
                <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-white">
                    ...
                    <li>
                        <Link href="https://midjourney.com/home/" className="mr-4 hover:underline md:mr-6"><FaDiscord size={48} className="pt-5 pr-5"/></Link>
                    </li>
                    <li>
                ...
                <span className="text-sm text-gray-500 sm:text-center dark:text-white sm:mb-0">© 2022 IArtist, Inc.</span>
            </div>  
        </footer>
    )
}
